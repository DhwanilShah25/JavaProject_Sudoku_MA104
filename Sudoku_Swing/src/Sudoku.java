...
public class Sudoku {
    ...
    public static void intialise(){
        ...
        Genrate.setBounds(850, 630, 150, 40);
        ...
        x.setBounds(1000, 550, 150, 40);
        y.setBounds(1000, 590, 150, 40);
        x.setVisible(false);
        y.setVisible(false);
                ...
                // countHint++;
                    ...
                    if(difficulty != 1){
                       ...
                       Genrate.setVisible(true);
                        ...
                        JOptionPane.showMessageDialog(null , "Bhai Sudoku rehne de koi Aur Game Khel le Easy me bhi Hint chaiye tuzhe toh" , "Roast" , JOptionPane.WARNING_MESSAGE);
                    }
        ...
        Genrate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(countHint < 3 && difficulty != 1){
                    countHint++;
                    String X  = x.getText();
                    int i = Integer.parseInt(X);
                    String Y  = y.getText();
                    int j = Integer.parseInt(Y);
                    Ans.setText("Ans: "+ ans[j-1][i-1]);
                    Genrate.setVisible(true);
                    Ans.setVisible(true);
                }
                else{
                    JOptionPane.showMessageDialog(null , "Kitne Hints Lega IIT m AAgaya hai na?" , "Galli Galloch" , JOptionPane.WARNING_MESSAGE);
                }
            ...
            for (int j = 0; j < 9; j++) {
                ...
                if(text.isEmpty() != true){
                    try{
                        ...
                        JOptionPane.showMessageDialog(null, "Nazro ko sahi jagah par rkhiye!!", "Error", JOptionPane.ERROR_MESSAGE);
